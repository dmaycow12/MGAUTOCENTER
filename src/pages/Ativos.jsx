  ...
  return (
    <div className="space-y-4">
      ...
      <div ref={useRef(null)} className="relative">
        ...
        {dropdownOpen && (
          <div className="absolute top-full left-0 right-0 mt-2 bg-gray-900 border border-gray-700 rounded-xl z-20 shadow-xl overflow-hidden">
            <button
            ...
            {categorias.map(cat => (
              <div key={cat} className="flex items-center hover:bg-gray-800 transition-all border-t border-gray-800">
                {editandoCategoria === cat ? (
                  <div className="flex-1 flex items-center gap-2 px-4 py-2">
                    ...
                    <button
                      ...
                      className="text-xs px-2 py-1 rounded-lg font-medium text-white transition-all"
