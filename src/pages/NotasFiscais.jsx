            ...
            <div key={nota.id} className="bg-gray-900 border border-gray-800 rounded-xl p-4 space-y-2 hover:border-gray-700 transition-all">
              <div className="flex items-start justify-between gap-2">
                ...
                <div className="flex gap-1">
                  ...
                  {(nota.xml_original || nota.chave_acesso || nota.spedy_id) && <button title="Ver XML" onClick={() => setXmlModal({ ...nota, xml_content: nota.xml_original || nota.xml_content })} className="w-7 h-7 flex items-center justify-center rounded-lg" style={{ color: ((nota.xml_original?.trim().startsWith("<") && nota.xml_original.trim().length > 500 && !nota.xml_original.includes("<nfeProc>...</nfeProc>")) || (nota.xml_url && nota.xml_url.startsWith("http") && nota.xml_url.length > 50)) ? "#00ff00" : "#ff2222" }}><Code className="w-3.5 h-3.5"/></button>}
                      ...
                      <div className="flex items-center justify-center gap-1">
                        ...
                        {(nota.xml_original || nota.chave_acesso || nota.spedy_id) && (
                          <button title="Ver XML" onClick={() => setXmlModal({ ...nota, xml_content: nota.xml_original || nota.xml_content })}
                            ...
                            style={{ color: ((nota.xml_original?.trim().startsWith("<") && nota.xml_original.trim().length > 500 && !nota.xml_original.includes("<nfeProc>...</nfeProc>")) || (nota.xml_url && nota.xml_url.startsWith("http") && nota.xml_url.length > 50) || (nota.xml_content?.trim().startsWith("<") && nota.xml_content.trim().length > 500 && !nota.xml_content.includes("<nfeProc>...</nfeProc>"))) ? "#00ff00" : "#ff2222" }}>
