export function gerarHTMLImpressao(os) {
  ...
  return "<!DOCTYPE html><html lang='pt-BR'><head><meta charset='UTF-8'/><title>Venda #" + (os.numero||"") + "</title><style>" + css + "</style></head><body>" +
    ...
    obsSection +
    (os.dados_adicionais ?
      "<div class='section' style='margin-top:8px'><div class='section-title'>Dados Adicionais</div><div class='info-grid'><div class='info-row'><div class='info-cell' style='min-height:40px'><div class='value' style='font-weight:normal;font-size:9pt;white-space:pre-wrap'>" + os.dados_adicionais + "</div></div></div></div></div>"
    : "") +
