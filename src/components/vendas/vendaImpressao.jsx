export function gerarHTMLImpressao(os) {
  ...
  const css = [
    ...
    "table th { background: #f0f0f0; border: 1px solid #ccc; padding: 2px 4px; text-align: left; font-size: 7pt; font-weight: bold; text-transform: uppercase; }",
    "table td { border: 1px solid #ddd; padding: 1px 4px; font-size: 7.5pt; line-height: 1.3; }",
  ...
  return "<!DOCTYPE html><html lang='pt-BR'><head><meta charset='UTF-8'/><title>Venda #" + (os.numero||"") + "</title><style>" + css + "</style></head><body>" +
    ...
    "<div class='info-row'><div class='info-cell' style='flex:3'><div class='label'>Nome / Razão Social</div><div class='value'>" + (os.cliente_nome||"—") + "</div></div><div class='info-cell' style='flex:2'><div class='label'>CPF/CNPJ</div><div class='value'>" + (os.cliente_cpf_cnpj||"") + "</div></div></div>" +
    "<div class='info-row'><div class='info-cell' style='flex:3'><div class='label'>Nome Social</div><div class='value'>" + (os.cliente_nome_fantasia||"—") + "</div></div><div class='info-cell' style='flex:2'><div class='label'>Contato</div><div class='value'>" + (os.cliente_telefone||"—") + "</div></div></div>" +
    ...
    obsSection +
    (os.dados_adicionais ?
      "<div class='section' style='margin-top:10px'><div class='section-title'>Dados Adicionais</div><div class='info-grid'><div class='info-row'><div class='info-cell' style='min-height:50px'><div class='value' style='font-weight:normal;font-size:9pt;white-space:pre-wrap'>" + os.dados_adicionais + "</div></div></div></div></div>"
    : "") +
