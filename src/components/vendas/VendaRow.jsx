  ...
  return (
    <>
      ...
      <tr className="border-b border-gray-800 last:border-0 hover:bg-gray-800/40 transition-all">
        ...
        {colunas.km && <td className="px-4 py-3"><InlineEdit ref={kmRef} value={os.quilometragem ? String(os.quilometragem) : ""} onSave={v => saveField("quilometragem", v ? Number(v) : null)} placeholder="—" /></td>}
