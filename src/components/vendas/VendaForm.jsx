...
export default function VendaForm({ os, clientes, veiculos, onClose, onSave }) {
  ...
  const onClienteChange = (clienteId) => {
    ...
    setForm(f => ({
      ...
      cliente_nome: c?.nome || "",
      cliente_nome_fantasia: isConsumidorSelecionado ? "" : (c?.nome_fantasia || ""),
      cliente_telefone: isConsumidorSelecionado ? "" : (c?.telefone || ""),
      cliente_email: isConsumidorSelecionado ? "" : (c?.email || ""),
      cliente_cpf_cnpj: isConsumidorSelecionado ? "" : (c?.cpf_cnpj || ""),
      cliente_endereco: isConsumidorSelecionado ? "" : (c?.endereco || ""),
      cliente_numero: isConsumidorSelecionado ? "" : (c?.numero || ""),
      cliente_bairro: isConsumidorSelecionado ? "" : (c?.bairro || ""),
      cliente_cidade: isConsumidorSelecionado ? "" : (c?.cidade || ""),
      cliente_estado: isConsumidorSelecionado ? "" : (c?.estado || ""),
    }));
    setClienteSearch("");
    setClienteSugestoes([]);
