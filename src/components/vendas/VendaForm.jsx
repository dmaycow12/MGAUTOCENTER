          ...
          <React.Fragment>
              ...
              <Section title="Produtos">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="text-white font-semibold text-sm">Total: R$ {fmt(form.valor_pecas)}</div>
                </div>
              </Section>
              ...
              <Section title="Serviços">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="text-white font-semibold text-sm">Total: R$ {fmt(form.valor_servicos)}</div>
                </div>
              </Section>
