            ...
            <>
              ...
              <Section title="Veículo">
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                  ...
                  <Field label="KM">
                   <input type="text" value={form.quilometragem} autoComplete="off" onChange={e => setForm(f => ({ ...f, quilometragem: e.target.value }))} className="input-dark" />
                  </Field>
                </div>
              </Section>
                      ...
                      <div key={i} className="bg-gray-800/50 rounded-xl p-3">
                        <div className="flex flex-wrap md:flex-nowrap gap-2 items-end">
                          ...
                          <div className="w-12 flex-shrink-0">
                            ...
                            <input type="text" value={p.quantidade} autoComplete="off" onChange={e => updatePeca(i, "quantidade", e.target.value)} className="input-dark" />
                          </div>
                          <div className="flex-1 min-w-[70px]">
                            <label className="text-xs text-gray-500 mb-1 block">Valor Unit.</label>
                            <input type="text" value={p.valor_unitario} autoComplete="off" onChange={e => updatePeca(i, "valor_unitario", e.target.value)} className="input-dark" />
                          </div>
                          <div className="flex-1 min-w-[70px]">
                      ...
                      <div key={i} className="bg-gray-800/50 rounded-xl p-3">
                        <div className="flex flex-wrap md:flex-nowrap gap-2 items-end">
                          <div className="relative flex-1 min-w-[140px]">
                            ...
                            <input value={s.descricao} onChange={e => updateServico(i, "descricao", e.target.value)} onBlur={() => setTimeout(() => setServicoSugestoes({ idx: null, lista: [] }), 200)} className="input-dark" placeholder="Nome do serviço" autoComplete="off" />
                          ...
                          <div className="flex-1 min-w-[70px]">
                            <label className="text-xs text-gray-500 mb-1 block">Valor Unit.</label>
                            <input type="text" value={s.valor} autoComplete="off" onChange={e => updateServico(i, "valor", e.target.value)} className="input-dark" />
                          </div>
                          <div className="flex-1 min-w-[70px]">
                            <label className="text-xs text-gray-500 mb-1 block">Total</label>
              ...
              <Section title="Pagamento">
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
                  <Field label="Desconto (R$)">
                    <input type="text" value={form.desconto} autoComplete="off" onChange={e => onDesconto(e.target.value)} className="input-dark" />
                  </Field>
