                  ...
                  {(form.pecas || []).map((p, i) => (
                    <div key={i} className="bg-gray-800/50 rounded-xl p-3 space-y-2">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <button onClick={() => removePeca(i)} className="text-red-400 hover:text-red-300 p-2 mt-4"><Trash2 className="w-4 h-4" /></button>
                      </div>
                    </div>
                  ))}
                </div>
                  ...
                  {(form.servicos || []).map((s, i) => (
                    <div key={i} className="bg-gray-800/50 rounded-xl p-3 space-y-2">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <button onClick={() => removeServico(i)} className="text-red-400 hover:text-red-300 p-2 mt-4"><Trash2 className="w-4 h-4" /></button>
                      </div>
                    </div>
                  ))}
                </div>
