                  ...
                  {(form.servicos || []).map((s, i) => (
                    <div key={i} className="bg-gray-800/50 rounded-xl p-3 space-y-2">
                      ...
                      <div className="grid grid-cols-3 gap-2">
                        ...
                        <div>
                          <label className="text-xs text-gray-500 mb-1 block">Valor Unit.</label>
                          <input type="number" value={s.valor} onChange={e => updateServico(i, "valor", e.target.value)} className="input-dark" placeholder="0,00" />
                        </div>
                        <div>
                          <label className="text-xs text-gray-500 mb-1 block">Total</label>
                      ...
                      <div className="flex justify-end">
                        <button onClick={() => removeServico(i)} className="text-red-400 hover:text-red-300 flex items-center gap-1 text-xs py-1"><Trash2 className="w-3.5 h-3.5" /> Remover</button>
                      </div>
                    </div>
                  ))}
                </div>
