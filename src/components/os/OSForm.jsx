...
export default function OSForm({ os, clientes, veiculos, onClose, onSave }) {
  ...
  return (
    ...
    <div className="fixed inset-0 bg-black/80 z-50 overflow-y-auto">
      ...
      <form autoComplete="off" onSubmit={e => e.preventDefault()} onKeyDown={e => { if (e.key === "Enter" && e.target.tagName !== "TEXTAREA") e.preventDefault(); }} className="bg-gray-900 border border-gray-700 rounded-2xl w-full max-w-3xl my-4">
