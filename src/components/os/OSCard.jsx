...
import { ChevronDown, Pencil, Printer, Trash2, MessageCircle, Phone, FileText } from "lucide-react";
...
export default function OSCard({ os, onEdit, onDelete, onRefresh }) {
  ...
  const menuItems = [
    ...
    { label: "Enviar orçamento (WhatsApp)", icon: MessageCircle, action: enviarOrcamento },
    { label: "Chamar no WhatsApp", icon: Phone, action: chamarWhatsApp },
