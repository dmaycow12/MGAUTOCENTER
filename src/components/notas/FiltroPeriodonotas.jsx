...
import { ChevronLeft, ChevronRight, ChevronDown, PlusCircle } from "lucide-react";

const MESES = ["Janeiro", "Fevereiro", "Março", "Abril", "Maio", "Junho", "Julho", "Agosto", "Setembro", "Outubro", "Novembro", "Dezembro"];

export default function FiltroPeriodonotas({
  filtroMes,
  filtroAno,
  usandoOutroPeriodo,
  customRange,
  ...
  return (
    <div className="flex gap-2 items-center">
      <button
        onClick={onEmitir}
        className="px-4 h-11 rounded-lg text-sm font-semibold transition-all flex items-center justify-center gap-2"
