        ...
        <div className="p-5 space-y-4">
          ...
          {resultado.detalhes.emitidasSemXml.length > 0 && (
            <div className="space-y-2">
              <h4 className="text-red-400 font-semibold text-sm">Emitidas sem XML:</h4>
              <div className="bg-gray-800 rounded-lg p-3 max-h-48 overflow-y-auto space-y-1">
                {resultado.detalhes.emitidasSemXml.map(n => (
                  <div key={n.id} className="text-xs text-gray-300">{n.tipo} {n.numero}/{n.serie} - {n.cliente}</div>
                ))}
              </div>
            </div>
          )}
          ...
          {resultado.detalhes.importadasSemXml.length > 0 && (
            <div className="space-y-2">
              <h4 className="text-red-400 font-semibold text-sm">Importadas sem XML:</h4>
              <div className="bg-gray-800 rounded-lg p-3 max-h-48 overflow-y-auto space-y-1">
