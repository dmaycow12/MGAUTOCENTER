...
Deno.serve(async (req) => {
  try {
    ...
    // SEMPRE usa o contador local como fonte de verdade para a série configurada
    ...
    return Response.json({ sucesso: true, proximo_numero: ultimoLocal + 1, ultimo_numero: ultimoLocal, fonte: 'local' });
